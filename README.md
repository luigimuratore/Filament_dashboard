...
3. **Pianificazione**: inserisci le stampe in coda nel calendario settimanale compatto, mostrato prima della coda e dimensionato per tenere tutte le 24 ore nel viewport senza barre di scorrimento. La griglia visibile è oraria, mentre il trascinamento resta preciso a intervalli di 15 minuti. La linea rossa evidenzia l’ora corrente. Ogni lavoro appare come un blocco alto in proporzione alla durata, può continuare dopo mezzanotte e può essere trascinato con il mouse su un nuovo giorno o orario; il rilascio salva automaticamente la modifica e gli orari sovrapposti vengono bloccati. Puoi anche usare “Sposta” per inserire l’orario da tastiera o rimettere il lavoro in coda. Al termine, conferma data e consumi effettivi: solo allora la stampa passa nello storico e aggiorna le bobine. Un avviso segnala quando il fabbisogno complessivo del piano supera il residuo disponibile.
